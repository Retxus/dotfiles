    ...
    function calendar_widget.toggle()
        ...
        if popup.visible then
            ...
            if placement == 'top' then
                awful.placement.top(popup, { margins = { top = dpi(30) }, parent = awful.screen.focused() })
            elseif placement == 'top_right' then
                awful.placement.top_right(popup, { margins = { top = dpi(60), right = dpi(10)}, parent = awful.screen.focused() })
            elseif placement == 'top_left' then
                awful.placement.top_left(popup, { margins = { top = dpi(30), left = dpi(10)}, parent = awful.screen.focused() })
            elseif placement == 'bottom_right' then
                awful.placement.bottom_right(popup, { margins = { bottom = dpi(30), right = dpi(10)},
                    parent = awful.screen.focused() })
            elseif placement == 'bottom_left' then
                awful.placement.bottom_left(popup, { margins = { bottom = dpi(30), left = dpi(10)},
                    parent = awful.screen.focused() })
            else
                awful.placement.top(popup, { margins = { top = dpi(30) }, parent = awful.screen.focused() })
            end
